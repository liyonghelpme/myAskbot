...
SECRET_KEY = '233f754d59671d05c4c7a90174d149b0'
...
#ASKBOT_EXTRA_SKINS_DIR = 'mySkin' #path to your private skin collection
...
#    (ASKBOT_EXTRA_SKINS_DIR, os.path.join(ASKBOT_ROOT, 'mySkin')),
)
STATICFILES_FINDERS = (
